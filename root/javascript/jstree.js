...
function createTree(arrName, startNode, openNode) {
	...
	if (nodes.length > 0) {
		...
		} else document.write("<img src=\"" + imgpath + "base.gif\" align=\"absbottom\" alt=\"\" />Source Server<br />");
	...
	for (var i = 0; i < nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			for (g=0; g<recursedNodes.length; g++) {
				if (recursedNodes[g] == 1) document.write("<img src=\"" + imgpath + "line.gif\" align=\"absbottom\" alt=\"\" />");
				else  document.write("<img src=\"" + imgpath + "empty.gif\" align=\"absbottom\" alt=\"\" />");
			}
			...
			if (hcn) {
				document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"" + imgpath + "folder")
					if (ino) document.write("open");
				document.write(".gif\" align=\"absbottom\" alt=\"Folder\" />");
			} else document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"" + imgpath + "page.gif\" align=\"absbottom\" alt=\"Page\" />");
